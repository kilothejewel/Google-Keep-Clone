...
export function NoteCard({ note, onDelete }) {
  return (
    <article className="group relative break-inside-avoid rounded-lg border border-gray-200 bg-white shadow-sm transition-shadow hover:shadow-md dark:border-[#5f6368] dark:bg-[#303134] dark:hover:shadow-lg dark:hover:shadow-black/20">
